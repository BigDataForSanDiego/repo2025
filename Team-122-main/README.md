...
#### Team Coordinator GitHub Username: `stanleyhello`
...
##### `Use weather, rent prices, hopsital admission data, etc. to predict trends in homelessness intensity in San Diego`

#### A visual

![Alt text](mock_actual_vs_predicted.png)
