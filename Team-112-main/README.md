...
#### Team Number: `Team-112`  

#### Team Name: `Team Sha`    

#### Team Coordinator GitHub Username: `LubabDesu`

#### Team Members `Lucas Yan : Lubabdesu, Kevin Bae : hba24`
                  

#### Your teamâ€™s hackathon idea in One sentence:
##### `A mobile app that leverages state-of-the-art voice recognition technology to analyze needs and assess risk factors of homeless people and connects them to relevant resources and organizations.`


#### A visual

<img width="924" height="1572" alt="image" src="https://github.com/user-attachments/assets/ebedb8cd-33ca-432f-9ab9-4d1c6907b652" />
