...
#### Team Name: `IV Desert Resolve`    

#### Team Coordinator GitHub Username: `cmolina9576`

#### Team Members `Caleb Molina (cmolina9576), Adriana Ramirez (), Roxanne Romero ()`

#### Your teamâ€™s hackathon idea in One sentence:
##### `Our goal is to create an interactive web-tool for individuals experiencing or at risk of homelessness to self-report needs and request services from local providers`
